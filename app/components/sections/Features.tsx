...
const features = [
  { icon: Mail,       title: "Inbox & Messaging",   headline: "See what matters. Reply with a draft already ready.",       desc: "Zuko reads your inbox, surfaces priority messages, and prepares replies for your review.",                         points: ["Priority surfaced automatically", "Replies drafted for your approval", "Emails captured as tasks or deals"] },
  ...
  { icon: DollarSign, title: "Finance & Invoicing",  headline: "Know what you’re owed. Collection emails ready to send.", desc: "Zuko tracks receivables, flags what’s overdue, and prepares payment follow-ups for your review.",                 points: ["Real-time receivables view", "Collection emails drafted for approval", "Connected to clients, projects, and deals"] },
